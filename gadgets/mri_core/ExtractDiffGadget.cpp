...
namespace Gadgetron {
    ...
    void ExtractDiffGadget::process(Core::InputChannel<Core::Image<std::complex<float>>>& in, Core::OutputChannel& out) {
        for (auto image : in) {
    ...
    ExtractDiffGadget::ExtractDiffGadget(const Core::Context& context, const Core::GadgetProperties& props)
    ...
    GADGETRON_GADGET_EXPORT(ExtractDiffGadget)

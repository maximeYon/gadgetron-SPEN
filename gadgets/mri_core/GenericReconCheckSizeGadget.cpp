            ...
            if (recon_bit_->rbit_[e].data_.data_.get_number_of_elements() > 0)
            {
              ...
              //  std::cout << " repetition" << curr_header.idx.repetition << std::endl;
                ...
                GDEBUG_STREAM("GenericCheckSizeGadget - incoming data array data: [RO E1 E2 CHA N S SLC] - [" << RO << " " << E1 << " " << E2 << " " << CHA << " " << N << " " << S << " " << SLC << "]");
                 ...
                 E1 = headers_.get_size(0);
                 E2 = headers_.get_size(1);
                 N = headers_.get_size(2);
                 S = headers_.get_size(3);
                 SLC = headers_.get_size(4);


                GDEBUG_STREAM("GenericCheckSizeGadget - incoming data array data: [ E1 E2 N S SLC] - [" << E1 << " " << E2 << " " << N << " " << S << " " << SLC << "]");
